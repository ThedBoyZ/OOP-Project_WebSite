...
booking_list.add_booking(Booking('Completed', [traveler1_1], '5001', 1500, '3001', contact1, [bkk_to_cnx]))
booking_list.add_booking(Booking('Waiting', [traveler2_1, traveler2_2], '5002', 1000, '3002', contact2, [cnx_to_bkk]))
booking_list.add_booking(Booking('Completed', [traveler3_1, traveler3_2], '5003', 1290, '3003', contact3, [dmk_to_cnx]))
