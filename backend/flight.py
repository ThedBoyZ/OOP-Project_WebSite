from airport_and_airline import AirlineCollection
...
class Flight:
    ...
    all_flight = []
    def __init__(self, airline, day, departure_airport, departure_day, departure_time, arrival_airport, arrival_day, arrival_time, baggage , refund, reschedule, id, type_travel) -> None:
    ...
    def get_flight_detail(self):
        return {
            ...
            "type_travel": self.type_travel
        }
class Element_Details_Flight:
    def __init__(self, day, departure_airport, arrival_airport, id_Vietjet, id_AirAsia, id_Smile_Air, id_Bangkok, baggage, refund, reschedule, type_travel):
        self.day = day
        self.departure_airport = departure_airport
        self.arrival_airport = arrival_airport
...
for element_details1.day , departure_list in departure_VietJet_BKK_to_CNX.items():
    ...
    for i in range(len(departure_list)):
        ...
        flight = Flight(airline_coll.airlines[0].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[3], None, arrival_list[i], element_details1.baggage[0], element_details1.refund, element_details1.reschedule, id_Vietjet, element_details1.type_travel[0])
...
for element_details1.day , departure_list in departure_Bangkok_BKK_to_CNX.items():
    ...
    for i in range(len(departure_list)):
        ...
        flight = Flight(airline_coll.airlines[1].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[3], None, arrival_list[i], element_details1.baggage[1], element_details1.refund, element_details1.reschedule, id_Bangkok, element_details1.type_travel[0])    
...
for element_details1.day , departure_list in departure_ThaiSmileAir_BKK_to_CNX.items():
    ...
    for i in range(len(departure_list)):
        ...
        flight = Flight(airline_coll.airlines[2].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[3], None, arrival_list[i], element_details1.baggage[1], element_details1.refund, element_details1.reschedule, id_Smile_Air, element_details1.type_travel[0])
...
for element_details1.day , departure_list in departure_AirAsia_BKK_to_CNX.items():
    ...
    for i in range(len(departure_list)):
        ...
        flight = Flight(airline_coll.airlines[3].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[3], None, arrival_list[i], element_details1.baggage[0], element_details1.refund, element_details1.reschedule, id_AirAsia, element_details1.type_travel[0])
...
for element_details1.day , departure_list in departure_VietJet_BKK_to_HKT.items():
    ...
    for i in range(len(departure_list)):
        id_Vietjet = vietjet_flight_ids[departure_list[i]]
        flight = Flight(airline_coll.airlines[0].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[4], None, arrival_list[i], element_details1.baggage[0], element_details1.refund, element_details1.reschedule, id_Vietjet, element_details1.type_travel[0])
...
for element_details1.day , departure_list in departure_Bangkok_BKK_to_HKT.items():
    ...
    for i in range(len(departure_list)):
        id_Bangkok = bangkok_flight_ids[departure_list[i]]
        flight = Flight(airline_coll.airlines[1].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[4], None, arrival_list[i], element_details1.baggage[1], element_details1.refund, element_details1.reschedule, id_Bangkok, element_details1.type_travel[0])    
...
for element_details1.day , departure_list in departure_ThaiSmileAir_BKK_to_HKT.items():
    ...
    for i in range(len(departure_list)):
        id_Smile_Air = ThaiSmileAir_flight_ids[departure_list[i]]
        flight = Flight(airline_coll.airlines[2].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[4], None, arrival_list[i], element_details1.baggage[1], element_details1.refund, element_details1.reschedule, id_Smile_Air, element_details1.type_travel[0])
...
for element_details1.day , departure_list in departure_AirAsia_BKK_to_HKT.items():
    ...
    for i in range(len(departure_list)):
        id_AirAsia = airasia_flight_ids[departure_list[i]]
        flight = Flight(airline_coll.airlines[3].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[4], None, arrival_list[i], element_details1.baggage[0], element_details1.refund, element_details1.reschedule, id_AirAsia, element_details1.type_travel[0])
...
for element_details1.day , departure_list in departure_VietJet_BKK_to_HDY.items():
    ...
    for i in range(len(departure_list)):
        id_Vietjet = vietjet_flight_ids[departure_list[i]]
        flight = Flight(airline_coll.airlines[0].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[5], None, arrival_list[i], element_details1.baggage[0], element_details1.refund, element_details1.reschedule, id_Vietjet, element_details1.type_travel[0])
...
for element_details1.day , departure_list in departure_ThaiSmileAir_BKK_to_HDY.items():
    ...
    for i in range(len(departure_list)):
        id_Smile_Air = ThaiSmileAir_flight_ids[departure_list[i]]
        flight = Flight(airline_coll.airlines[2].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[5], None, arrival_list[i], element_details1.baggage[1], element_details1.refund, element_details1.reschedule, id_Smile_Air, element_details1.type_travel[0])
...
for element_details1.day , departure_list in departure_VietJet_BKK_to_UTH.items():
    ...
    for i in range(len(departure_list)):
        id_Vietjet = vietjet_flight_ids[departure_list[i]]
        flight = Flight(airline_coll.airlines[0].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[6], None, arrival_list[i], element_details1.baggage[0], element_details1.refund, element_details1.reschedule, id_Vietjet, element_details1.type_travel[0])
...
for element_details1.day , departure_list in departure_ThaiSmileAir_BKK_to_UTH.items():
    ...
    for i in range(len(departure_list)):
        id_Smile_Air = ThaiSmileAir_flight_ids[departure_list[i]]
        flight = Flight(airline_coll.airlines[2].name, element_details1.day, element_details1.departure_airport[0], None, departure_list[i],\
                        element_details1.arrival_airport[6], None, arrival_list[i], element_details1.baggage[1], element_details1.refund, element_details1.reschedule, id_Smile_Air, element_details1.type_travel[0])
###################################################################################################################################################################################################################################################################################
# my_trip = Trip()
